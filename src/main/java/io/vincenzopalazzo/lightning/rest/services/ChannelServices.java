...
public class ChannelServices {
    ...
    @OpenApi(
            path = "/channel/listchannels",            // only necessary to include when using static method references
            ...
            tags = {SERVICE},
            responses = {
                    @OpenApiResponse(status = "200", content = {@OpenApiContent(from = CLightningListChannels.class)})
            }
    )
